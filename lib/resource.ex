defmodule AshSitemap.Resource do
  ...
  @url %Spark.Dsl.Entity{
    ...
    schema: [
      path: [
        ...
        doc: "The path to append to the host url",
        required: true
      ],
      ...
      news: [
        ...
        doc:
          "News attributes for the url. See https://www.google.com/schemas/sitemap-news/0.9/sitemap-news.xsd",
        required: false,
        keys: [
          publication_date: [
            type: {
      ...
      image: [
        type: :non_empty_keyword_list,
        doc:
          "Image attributes for the url. See https://www.google.com/schemas/sitemap-image/1.1/sitemap-image.xsd. Encloses all information about a single image. Each URL (<loc> tag) can include up to 1,000 <image:image> tags.",
        required: false,
        keys: [
          loc: [
            type: {
      ...
      video: [
        type: :non_empty_keyword_list,
        doc:
          "Video attributes for the url. See https://www.google.com/schemas/sitemap-video/1.1/sitemap-video.xsd. ",
        required: false,
        keys: [
          title: [
            type: {
  ...
  @sitemap %Spark.Dsl.Section{
    name: :sitemap,
    describe: "Configuration for generating a sitemap",
    entities: [
    ...
    schema: [
      host: [
        type: :string,
        doc: "The host to use for the sitemap."
      ],
      path: [
        type: {
          :or,
      ...
      read_action: [
        type: :atom,
        doc: "The read action to use when generating from the resource."
      ],
      file_path: [
        type: :string,
        doc: "The path to store the sitemap file."
      ],
      compress: [
        type: :boolean,
        doc: "Whether to compress the generated sitemap file."
      ]
    ]
  }
